from . import views
from .views import AcceptInvitationView, SubmissionDetail, TaskDetail, SubmissionListView
...
urlpatterns = [
    ...
    path("submissions/<int:team>", SubmissionListView.as_view(), name="submission-list"),
